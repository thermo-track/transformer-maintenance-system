...
| *Loose Joint (Faulty)* | Middle area reddish/orange-yellowish, background blue/black | Faulty | ⚠ Critical |
| *Loose Joint (Potential)* | Middle area yellowish (not reddish/orange), background blue/black | Potentially Faulty | ⚡ Warning |
| *Point Overload (Faulty)* | Small spot reddish/orange-yellowish, rest of wire black/blue or yellowish | Faulty | ⚠ Critical |
